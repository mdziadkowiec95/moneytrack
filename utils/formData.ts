/**
 * Reference: https://github.com/microsoft/TypeScript/issues/43797#issuecomment-1311633838
 */
...
export function createFormData<T extends Record<string, TypedFormDataValue>>(
  data?: HTMLFormElement | null
): TypedFormData<T> {
  return new FormData(data || undefined) as unknown as TypedFormData<T>
}
